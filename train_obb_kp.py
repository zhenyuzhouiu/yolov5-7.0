# Based on the train.py for detecting oriented bounding box
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if ni - last_opt_step >= accumulate:
                ...
                torch.nn.utils.clip_grad_norm_(model.parameters(), max_norm=10.0,
                                               error_if_nonfinite=False)  # clip gradients
...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=2400, help='train, val image size (pixels)')
